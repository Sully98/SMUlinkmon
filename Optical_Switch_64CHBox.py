...
def main():
    timeslot = 600                
    command_list1 = [ b'<OSW01_OUT_01>',b'<OSW01_OUT_02>', b'<OSW01_OUT_03>', b'<OSW01_OUT_04>',\
                     b'<OSW01_OUT_05>', b'<OSW01_OUT_06>', b'<OSW01_OUT_07>', b'<OSW01_OUT_08>',\
                     b'<OSW01_OUT_09>', b'<OSW01_OUT_10>', b'<OSW01_OUT_11>', b'<OSW01_OUT_12>',\
                     b'<OSW01_OUT_13>', b'<OSW01_OUT_14>', b'<OSW01_OUT_15>', b'<OSW01_OUT_16>',\
                     b'<OSW01_OUT_17>', b'<OSW01_OUT_18>', b'<OSW01_OUT_19>', b'<OSW01_OUT_20>',\
                     b'<OSW01_OUT_21>', b'<OSW01_OUT_22>', b'<OSW01_OUT_23>', b'<OSW01_OUT_24>',\
                     b'<OSW01_OUT_25>', b'<OSW01_OUT_26>', b'<OSW01_OUT_27>', b'<OSW01_OUT_28>',\
                     b'<OSW01_OUT_29>', b'<OSW01_OUT_30>', b'<OSW01_OUT_31>', b'<OSW01_OUT_32>']
    command_list2 = [b'<OSW01_OUT_01>',b'<OSW01_OUT_02>', b'<OSW01_OUT_03>', b'<OSW01_OUT_04>',\
                     b'<OSW01_OUT_05>', b'<OSW01_OUT_06>', b'<OSW01_OUT_07>', b'<OSW01_OUT_08>',\
                     b'<OSW01_OUT_09>', b'<OSW01_OUT_10>', b'<OSW01_OUT_11>', b'<OSW01_OUT_12>',\
                     b'<OSW01_OUT_13>', b'<OSW01_OUT_14>', b'<OSW01_OUT_15>', b'<OSW01_OUT_16>',\
                     b'<OSW01_OUT_17>', b'<OSW01_OUT_18>', b'<OSW01_OUT_19>', b'<OSW01_OUT_20>',\
   ...
   # print("Serial port: %s"%ser1.name)
    ...
    inst1 = rm.open_resource('GPIB1::5::INSTR')     # GPIB address
    time.sleep(1)
    ...
    while True:
        ...
        try:
            ...
            for sw3_index in range(2):
                ser3.write(command_list3[sw3_index])   #psuedocode. follow format. look at optical_switch_controller.py original code 
                ...
                if  sw3_index == 0:
                    for sw1_index in range(32):
                        ...
                        #s = ser1.read(14)
                            ...
                            data = io.BytesIO('\n'.join(lines).encode())
                            try:
                                ftp.storlines("STOR " + "Channel_"+str(mychannel1)+"/"+date+"/"+"waveform_data_channel%s_%s.txt"%(mychannel1, timestamp),fp=data)
                    ...
                    for sw2_index in range(32):
                        try:
                            ...
                            wavelength2 = []                             
                            yydata2 = []
                            timestamp2 = time.strftime('%Y-%m-%d_%H-%M-%S',time.localtime(time.time()))
                            ...
                            data = io.BytesIO('\n'.join(lines).encode())
                            try:
                                ftp.storlines("STOR " + "Channel_"+str(mychannel2)+"/"+date2+"/"+ "waveform_data_channel%s_%s.txt"%(mychannel2, timestamp2),fp=data)
                            except Exception as e:
                                print("Failed box upload",e)
                        except Exception as e:
